...
CREATE TABLE `ei_results` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(45) DEFAULT NULL,
  `task_questions` varchar(1000) DEFAULT NULL,
  `task_answers` varchar(1000) DEFAULT NULL,
  `task_cheats` varchar(600) DEFAULT NULL,
  `time_to_answer` varchar(600) DEFAULT NULL,
