...
const experiences = [
  ...
  { title: 'Emotions et performances', description:"Expérience portant sur les émotions et les capacités cognitives. Le but est d'atteindre un score maximal à des exercices mêlant réflexion, logique, mémoire et chance.", image:require("../images/emotions.png"),timeExpected : '20 minutes',imageTitle:"emotions", url:'experience/EmotionsPerformancesscreen' },
